...
int main(int argc, const char * argv[]) {
    ...
    fstream file3;
    fstream file4;
    string fileName3 = "BurnConfig" + to_string(p0) + ".txt";
    string fileName4 = "HKConfig" + to_string(p0) + ".txt";
    file3.open(fileName3, ios::out | ios::trunc);
    if (file3.good()==false) cout << "Failed to open file!";
    file4.open(fileName4, ios::out | ios::trunc);
    if (file4.good()==false) cout << "Failed to open file!";
